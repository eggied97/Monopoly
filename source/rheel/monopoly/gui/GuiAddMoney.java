...
public class GuiAddMoney extends Gui
{
	private final GuiMoney money;
	private int tick = 0;

	public GuiAddMoney(GameValues values, Money type)
	{
	...
	public void drawGui()
	{
		if (++this.tick <= 70)
		{
			...
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 0.5F - this.tick / 200.0F);
			Monopoly.getInstance().getEngine().drawTexturedRectangle(0, 0, 1, 254, 256, 132, 1, 1);
